...
#[test]
#[should_panic(expected = "HostError: Error(Contract, #11)")] // UnauthorizedRole
...
#[test]
#[should_panic(expected = "HostError: Error(Contract, #35)")] // InsufficientAccumulatedFees
...
#[test]
#[should_panic(expected = "HostError: Error(Contract, #45)")] // PotentialOverflow
